...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      {/* Decorative Glows */}
      <div className="absolute top-1/4 -right-20 w-80 h-80 bg-[#00F2FF]/10 blur-[120px] rounded-full"></div>
      <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-[#00F2FF]/10 blur-[120px] rounded-full"></div>
          ...
          <div className="bg-[#1a1c21]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-black text-white mb-2 tracking-tight">
                NEW <span className="text-[#00F2FF]">USER ? </span>
              </h2>
            ...
            <form className="space-y-5" onSubmit={handleSign}>
              {/* Name Field */}
              ...
              <button
                type="submit"
                className="w-full bg-[#00F2FF] hover:bg-[#00d8e6] text-black font-black py-4 rounded-2xl shadow-[0_0_20px_rgba(0,242,255,0.3)] transition-all transform active:scale-[0.98] mt-4"
              >
                CREATE ACCOUNT
              </button>
            </form>
